...
class Respawn():
    def __init__(self):
        ...
        self.init_goal_x = random.randrange(-27, 28) / 10.0
        self.init_goal_y = random.randrange(-27, 28) / 10.0
    ...
    def getPosition(self, position_check=False, delete=False):
        ...
        while position_check:
            goal_x = random.randrange(-27, 28) / 10.0
            goal_y = random.randrange(-27, 28) / 10.0
