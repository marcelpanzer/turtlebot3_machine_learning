...
class Trainer:
    ...
    def save_models(self, episode_count):
        ...
        torch.save(self.target_critic_2.state_dict(), dirPath + '/Models/real1/'+str(episode_count)+ '_critic_2.pt')
...
if __name__ == '__main__':
    ...
    for ep in range(MAX_EPISODES):
        ...
        for step in range(MAX_STEPS):
            ...
            state = next_state
            print ram.len, ">=" ,0.1 * MAX_STEPS, is_training
